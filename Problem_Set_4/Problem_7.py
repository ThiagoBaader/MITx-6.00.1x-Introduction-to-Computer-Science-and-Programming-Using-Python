...
def playGame(wordList):
    ...
    while True:
        ans = str(input("Enter n to deal a new hand, r to replay the last hand, or e to end game: ")).lower()
        if ans == 'e':
            break
        elif ans == 'n':
            while True:
                ans2 = str(input("Enter u to have yourself play, c to have the computer play: ")).lower()
                if ans2 == 'u':
